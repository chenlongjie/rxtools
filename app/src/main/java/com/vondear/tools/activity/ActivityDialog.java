...
public class ActivityDialog extends ActivityBase {
    ...
    public static Bitmap createBmpRadius(int color){
...
//                page_item.setImageResource(R.drawable.coin);
                Bitmap bitmap=removeYuanjiao(createBmpRadius(getResources().getColor(R.color.red)),5);
                Drawable drawable=new BitmapDrawable(bitmap);
                page_item.setBackgroundDrawable(drawable);
...
//                new RxDialogLoading(mContext).show();
                final RxDialogLoading rxDialogLoading = new RxDialogLoading(mContext, R.style.tran_dialog);
                rxDialogLoading.show();
                rxDialogLoading.setCancelable(false);
                rxDialogLoading.setLoadingText("加载中...");
                rxDialogLoading.setCancelClickListener(new RxDialogLoading.OnCancelClickListener() {
                    @Override
            ...
            case R.id.button_DialogScaleView:
                ...
                rxDialogScaleView.setFullScreen();
                rxDialogScaleView.skipTools();
