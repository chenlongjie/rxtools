...
public class ActivityPopupView extends ActivityBase implements RxToolTipsManager.TipListener {
    ...
    public static final String TIP_TEXT = "TipTipTipTip";
    ...
    private void initPopupView() {
        ...
        titlePopup.setColorItemText(R.color.blue);
     /*   titlePopup.addAction(new ActionItem("标清"));
        titlePopup.addAction(new ActionItem("高清"));
        titlePopup.addAction(new ActionItem("超清"));  */
        titlePopup.addAction(new ActionItem("未盘点"));
        titlePopup.addAction(new ActionItem("物资存在"));
        titlePopup.addAction(new ActionItem("物资不存在"));
